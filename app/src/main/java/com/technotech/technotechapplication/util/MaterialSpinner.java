...
/**
 * Created by Welcome on 22-02-2017.
 */
...
public class MaterialSpinner extends Spinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    private static final String TAG = fr.ganfra.materialspinner.MaterialSpinner.class.getSimpleName();
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray defaultArray = context.obtainStyledAttributes(new int[]{fr.ganfra.materialspinner.R.attr.colorControlNormal, fr.ganfra.materialspinner.R.attr.colorAccent});
        ...
        hintColor = array.getColor(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_hintColor, baseColor);
        ...
        enableErrorLabel = array.getBoolean(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_enableErrorLabel, true);
        enableFloatingLabel = array.getBoolean(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_enableFloatingLabel, true);
       /* typeface=util.getsansregular();
        String typefacePath = null;*//*array.getString(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_typeface);*//*
    ...
    public void setSelection(final int position) {
        this.post(new Runnable() {
            @Override
            public void run() {
                com.technotech.technotechapplication.util.MaterialSpinner.super.setSelection(position);
            }
        });
    }
    ...
    private void initPadding() {
        ...
        innerPaddingTop = 30/*getPaddingTop()*/;
        innerPaddingLeft = getPaddingLeft();
        innerPaddingRight = getPaddingRight();
        innerPaddingBottom = 30/*getPaddingBottom()*/;
    ...
    private void updateBottomPadding() {
        ...
        if (enableErrorLabel) {
            extraPaddingBottom +=5;/* (int) ((textMetrics.descent - textMetrics.ascent) * currentNbErrorLines);*/
        }
        updatePadding();
    }

    private void initDimensions() {
        underlineTopSpacing = 2;/*getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.underline_top_spacing);*/
        underlineBottomSpacing = 2;/*getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.underline_bottom_spacing);*/
        floatingLabelTopSpacing =2;/*; getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.floating_label_top_spacing);*/
        floatingLabelBottomSpacing = 2;/*getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.floating_label_bottom_spacing);*/
        rightLeftSpinnerPadding = alignLabels ? 2/*getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.right_left_spinner_padding)*/ : 0;
        ...
        minContentHeight = (int) getResources().getDimension(fr.ganfra.materialspinner.R.dimen.min_content_height);
    }
    ...
    */
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        super.setAdapter(new com.technotech.technotechapplication.util.MaterialSpinner.HintAdapter(adapter, getContext()));
    }
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        public Object getItem(int position) {
            position = hint != null ? position - 1 : position;
            return (position == -1) ? util.changeTextFont(typeface,hint) :mSpinnerAdapter.getItem(position) ;
        }
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            textView.setTextColor(com.technotech.technotechapplication.util.MaterialSpinner.this.isEnabled() ? hintColor : disabledColor);
